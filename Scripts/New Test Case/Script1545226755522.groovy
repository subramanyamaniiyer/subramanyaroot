...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_HR Block/img_Please enter a quantity_lo (1)'),1, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_HR Block/h2_Spend less but get more wit'),1, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_HR Block/div_Basic            Deluxe'),1, FailureHandling.CONTINUE_ON_FAILURE)
