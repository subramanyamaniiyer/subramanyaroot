...
WebUI.navigateToUrl('http://staging.cvs.triadretail.net/shop-assets/04_CVS_V1078_Q1BZs/bz-ccf2019/')

WebUI.click(findTestObject('04_CVS_V1078_ccf/img_Shop now_img-rw trm-respon'))
